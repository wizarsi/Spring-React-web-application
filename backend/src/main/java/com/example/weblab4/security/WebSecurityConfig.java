...
import com.example.weblab4.security.jwt.AuthEntryPointJwt;
import com.example.weblab4.security.jwt.AuthTokenFilter;
import com.example.weblab4.services.auth.UserDetailsImplService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/web-lab4/api/app/**").authenticated()
